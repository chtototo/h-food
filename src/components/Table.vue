...
<template>
    <div class="w-[100%]">
        <input v-model="search" type="text" placeholder="Название продукта"
            class="h-[150px] w-[100%] mb-[20px] border-[1px] box-border border-gray-500 appearance-none rounded-[35px] bg-white px-[15px]">
        ...
        <div class="">
            ...
            <div v-for="product of prods"
                class="w-[100%] text-gray-700 grid grid-cols-[40%,15%,15%,15%,15%] text-center border-b-[1px] border-gray-500 items-center h-[200px]">
